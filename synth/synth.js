...
import { reverbFunction, compressorFunction, bitCrushFunction } from './effects.js';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //COMPRESSOR
    const compressor = compressorFunction(audioCtx);
    ...
    let convolverEffect = reverbFunction(audioCtx);

    //BIT CRUSHER EFFECT
    //USE bits AND normFreq TO CHANGE BIT RATE AND NORM FREQ
    let bitcrushEffect = bitCrushFunction(audioCtx);
